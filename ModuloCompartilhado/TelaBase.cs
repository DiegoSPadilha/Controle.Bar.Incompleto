...
namespace Controle.Bar.ModuloCompartilhado
{
    public abstract class TelaBase
    {
        ...
        protected RepositorioBase repositorioFuncionario = null;
        ...
        public virtual void VisualizarRegistros(bool mostrarCabecalho)
        {
            ...
            ArrayList registros = repositorioFuncionario.SelecionarTodos();
            ...
            MostrarTabela(registros, funcionario);
        }
        ...
        public virtual void EditarRegistro()
        {
            ...
            repositorioFuncionario.Editar(registro, registroAtualizado);
        ...
        public virtual EntidadeBase EncontrarRegistro(string textoCampo)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    registroSelecionado = repositorioFuncionario.SelecionarPorId(id);
        ...
        protected override EntidadeBase ObterRegistro(Funcionario funcionario)
        {
